...
namespace MehrIt\OttoOrdersApiClient\Model;
...
'position_items' => '\MehrIt\OttoOrdersApiClient\Model\PositionItem[]',
'order_lifecycle_information' => '\MehrIt\OttoOrdersApiClient\Model\OrderLifecycleInformation',
'initial_service_fees' => '\MehrIt\OttoOrdersApiClient\Model\InitialServiceFee[]',
'delivery_address' => '\MehrIt\OttoOrdersApiClient\Model\Address',
'invoice_address' => '\MehrIt\OttoOrdersApiClient\Model\Address',
'links' => '\MehrIt\OttoOrdersApiClient\Model\Link[]'    ];
...
'links' => 'getLinks'    ];
     ...
     * Gets position_items
     *
     * @return \MehrIt\OttoOrdersApiClient\Model\PositionItem[]
     */
     ...
     * Sets position_items
     *
     * @param \MehrIt\OttoOrdersApiClient\Model\PositionItem[] $position_items The physical position items of this order. Multiple position item can refer to the same product
     *
     * @return $this
     */
     ...
     *
     * @return \MehrIt\OttoOrdersApiClient\Model\OrderLifecycleInformation
     */
     ...
     *
     * @param \MehrIt\OttoOrdersApiClient\Model\OrderLifecycleInformation $order_lifecycle_information order_lifecycle_information
     *
     * @return $this
     */
     ...
     *
     * @return \MehrIt\OttoOrdersApiClient\Model\InitialServiceFee[]
     */
     ...
     *
     * @param \MehrIt\OttoOrdersApiClient\Model\InitialServiceFee[] $initial_service_fees The initial Service Fees on customer checkout
     *
     * @return $this
     */
     ...
     *
     * @return \MehrIt\OttoOrdersApiClient\Model\Address
     */
     ...
     *
     * @param \MehrIt\OttoOrdersApiClient\Model\Address $delivery_address delivery_address
     *
     * @return $this
     */
     ...
     *
     * @param \MehrIt\OttoOrdersApiClient\Model\Address $invoice_address invoice_address
     *
     * @return $this
     */
     ...
     * Gets links
     *
     * @return \MehrIt\OttoOrdersApiClient\Model\Link[]
     */
     ...
     * Sets links
     *
     * @param \MehrIt\OttoOrdersApiClient\Model\Link[] $links Order related links like the link to fetch the single partner order
     *
     * @return $this
     */
