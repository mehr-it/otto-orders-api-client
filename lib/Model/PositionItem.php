...
'item_value_gross_price' => '\MehrIt\OttoOrdersApiClient\Model\Amount',
'product' => '\MehrIt\OttoOrdersApiClient\Model\Product',
'tracking_info' => '\MehrIt\OttoOrdersApiClient\Model\TrackingInfo',
'sent_date' => '\DateTime',
...
self::FULFILLMENT_STATUS_CANCELLED_BY_MARKETPLACE,        ];
     ...
     *
     * @return \MehrIt\OttoOrdersApiClient\Model\Amount
     */
     ...
     *
     * @param \MehrIt\OttoOrdersApiClient\Model\Amount $item_value_gross_price item_value_gross_price
     *
     * @return $this
     */
     ...
     * Gets product
     *
     * @return \MehrIt\OttoOrdersApiClient\Model\Product
     */
     ...
     * Sets product
     *
     * @param \MehrIt\OttoOrdersApiClient\Model\Product $product product
     *
     * @return $this
     */
     ...
     * Gets tracking_info
     *
     * @return \MehrIt\OttoOrdersApiClient\Model\TrackingInfo
     */
     ...
     * Sets tracking_info
     *
     * @param \MehrIt\OttoOrdersApiClient\Model\TrackingInfo $tracking_info tracking_info
     *
     * @return $this
     */
