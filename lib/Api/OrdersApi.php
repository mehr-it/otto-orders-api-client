...
namespace MehrIt\OttoOrdersApiClient\Api;
...
use MehrIt\OttoOrdersApiClient\HeaderSelector;
...
class OrdersApi
{
     ...
     *
     * @throws \MehrIt\OttoOrdersApiClient\ApiException on non-2xx response
     ...
     *
     * @param  string $from_date Defines, which minimum change date the returned order should have. In ISO 8601 format. (optional)
     * @param  string $from_order_date Lower boundary of filter by order date: Only orders newer than the date specified will be returned. In ISO 8601 format. (optional)
     * @param  string $to_order_date Upper boundary of filter by order date: Only orders older than the date specified will be returned. In ISO 8601 format. (optional)
     ...
     * @param  string $nextcursor For paging request this cursor is required. If a next cursor is provided, the only other request parameter being considered is &#x27;limit&#x27;.&lt;br&gt;Only the cursor string is required, not the whole link to the cursor.&lt;br&gt;Example: nextcursor&#x3D;eyJmZiI6MTU5NDg5NDQ3MTA1OCwicGlmIjoiNDcxM... (optional)
     * @param  string $search_term The search term for partial text search. (optional)
     *
     * @throws \MehrIt\OttoOrdersApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MehrIt\OttoOrdersApiClient\Model\PartnerOrderList
     */
    public function findPartnerOrders($from_date = null, $from_order_date = null, $to_order_date = null, $fulfillment_status = null, $limit = '128', $order_direction = 'ASC', $order_column_type = 'ORDER_LIFECYCLE_DATE', $mode = 'BUCKET', $nextcursor = null, $search_term = null)
    {
        list($response) = $this->findPartnerOrdersWithHttpInfo($from_date, $from_order_date, $to_order_date, $fulfillment_status, $limit, $order_direction, $order_column_type, $mode, $nextcursor, $search_term);
        return $response;
    }
     ...
     * @throws \MehrIt\OttoOrdersApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MehrIt\OttoOrdersApiClient\Model\PartnerOrderList, HTTP status code, HTTP response headers (array of strings)
     */
    public function findPartnerOrdersWithHttpInfo($from_date = null, $from_order_date = null, $to_order_date = null, $fulfillment_status = null, $limit = '128', $order_direction = 'ASC', $order_column_type = 'ORDER_LIFECYCLE_DATE', $mode = 'BUCKET', $nextcursor = null, $search_term = null)
    {
        $returnType = '\MehrIt\OttoOrdersApiClient\Model\PartnerOrderList';
        $request = $this->findPartnerOrdersRequest($from_date, $from_order_date, $to_order_date, $fulfillment_status, $limit, $order_direction, $order_column_type, $mode, $nextcursor, $search_term);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoOrdersApiClient\Model\PartnerOrderList',
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findPartnerOrdersAsync($from_date = null, $from_order_date = null, $to_order_date = null, $fulfillment_status = null, $limit = '128', $order_direction = 'ASC', $order_column_type = 'ORDER_LIFECYCLE_DATE', $mode = 'BUCKET', $nextcursor = null, $search_term = null)
    {
        return $this->findPartnerOrdersAsyncWithHttpInfo($from_date, $from_order_date, $to_order_date, $fulfillment_status, $limit, $order_direction, $order_column_type, $mode, $nextcursor, $search_term)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findPartnerOrdersAsyncWithHttpInfo($from_date = null, $from_order_date = null, $to_order_date = null, $fulfillment_status = null, $limit = '128', $order_direction = 'ASC', $order_column_type = 'ORDER_LIFECYCLE_DATE', $mode = 'BUCKET', $nextcursor = null, $search_term = null)
    {
        $returnType = '\MehrIt\OttoOrdersApiClient\Model\PartnerOrderList';
        $request = $this->findPartnerOrdersRequest($from_date, $from_order_date, $to_order_date, $fulfillment_status, $limit, $order_direction, $order_column_type, $mode, $nextcursor, $search_term);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function findPartnerOrdersRequest($from_date = null, $from_order_date = null, $to_order_date = null, $fulfillment_status = null, $limit = '128', $order_direction = 'ASC', $order_column_type = 'ORDER_LIFECYCLE_DATE', $mode = 'BUCKET', $nextcursor = null, $search_term = null)
    {
     ...
     *
     * @param  string $order_number The Order Number used for searching (required)
     *
     * @throws \MehrIt\OttoOrdersApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MehrIt\OttoOrdersApiClient\Model\PartnerOrder
     */
     ...
     * @throws \MehrIt\OttoOrdersApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MehrIt\OttoOrdersApiClient\Model\PartnerOrder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPartnerOrderByOrderNumberWithHttpInfo($order_number)
    {
        $returnType = '\MehrIt\OttoOrdersApiClient\Model\PartnerOrder';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoOrdersApiClient\Model\PartnerOrder',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function getPartnerOrderByOrderNumberRequest($order_number)
    {
        ...
        $resourcePath = '/v3/orders/{orderNumber}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $sales_order_id The Sales Order Id used for searching (required)
     *
     * @throws \MehrIt\OttoOrdersApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MehrIt\OttoOrdersApiClient\Model\PartnerOrder
